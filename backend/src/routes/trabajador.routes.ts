...
import { basico, borrar, crear, editar, listar, obtener } from "../controllers/trabajador.controller";
import { authMiddleware } from "../middlewares/auth.middleware";
import { permitirRoles } from "../middlewares/role.middleware";
import { validarAltaTrabajador, validarEdicionTrabajador, validarIdTrabajador } from "../middlewares/validarTrabajador";

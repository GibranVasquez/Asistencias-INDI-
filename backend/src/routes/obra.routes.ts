...
import { listar, obtenerActual, editarActual } from "../controllers/obra.controller";
...
obraRouter.get("/", authMiddleware, permitirRoles(RolUsuario.administrador, RolUsuario.rh), listar);

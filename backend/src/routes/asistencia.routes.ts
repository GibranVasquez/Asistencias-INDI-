...
import { exportarListaSemanal, listar, reciente, registrar } from "../controllers/asistencia.controller";
...
import { validarAsistencia, validarExportarListaSemanal, validarFiltroAsistencia } from "../middlewares/validarAsistencia";

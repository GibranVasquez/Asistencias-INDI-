...
describe("analítica pura de asistencia", () => {
  ...
  it("selecciona la marcación más temprana sin depender del orden de entrada", () => {
    const marcas = unaMarcaPorDia([
      { trabajadorId: "t1", seccionId: "s1", tipoMarcacion: "entrada", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T08:15:00Z") },
      { trabajadorId: "t1", seccionId: "s1", tipoMarcacion: "entrada", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T07:58:00Z") },
    ]);
  ...
  it("preserva límite inclusivo, ausencia de horario y porcentaje nulo", () => {
    ...
    const resumen = calcularResumen([
      { trabajadorId: "t1", seccionId: "s1", tipoMarcacion: "entrada", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T08:10:00Z") },
      { trabajadorId: "t2", seccionId: "s1", tipoMarcacion: "entrada", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T08:11:00Z") },
      { trabajadorId: "t3", seccionId: "s2", tipoMarcacion: "entrada", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T08:00:00Z") },
    ...
    expect(calcularResumen([
      { trabajadorId: "t4", seccionId: "sin-horario", tipoMarcacion: "entrada", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T08:00:00Z") },
  ...
  it("evalúa puntualidad solo con entradas explícitas", () => {
    const horario = { horaEntrada: d("2026-08-03T08:00:00Z"), toleranciaMinutos: 10 };
    const resumen = calcularResumen([
      { trabajadorId: "t1", seccionId: "s1", tipoMarcacion: "salida", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T07:00:00Z") },
      { trabajadorId: "t1", seccionId: "s1", tipoMarcacion: "entrada", fecha: d("2026-08-03T00:00:00Z"), hora: d("2026-08-03T08:05:00Z") },
    ], { seccionHorario: new Map([["s1", horario]]) }, [d("2026-08-03T00:00:00Z")], 1, false);
    expect(resumen).toMatchObject({ presentes: 1, aTiempo: 1, tardanzas: 0 });
  });

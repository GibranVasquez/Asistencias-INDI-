...
export const NAVEGACION: NavegacionItem[] = [
  ...
  { id: "encargado", path: "/panel/encargado", label: "Encargado", group: "operacion", roles: ["rh", "encargado_seccion"], icon: icono(<><path d="m12 2-10 5 10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></>) },

...
interface Window {
  indiApp?: {
    ...
    apiBaseUrl: string;
    terminales: { leerConfig(terminalId: string): Promise<unknown>; guardarConfig(config: unknown): Promise<unknown>; probarConexion(config: unknown): Promise<unknown>; descargarMarcaciones(config: unknown): Promise<unknown>; descubrir(terminales: unknown[]): Promise<unknown> };

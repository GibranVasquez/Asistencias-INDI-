  ...
  return (
    <div style={{ padding: "26px 30px 36px" }}>
      ...
      <div className="barra-filtros" style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "flex-end", marginTop: 20 }}>
        ...
        <div style={{ display: "flex", gap: 6 }}><Boton type="button" variante="outline" tamano="pequeno" onClick={() => exportar("pdf")}>Exportar PDF</Boton><Boton type="button" variante="outline" tamano="pequeno" onClick={() => exportar("excel")}>Exportar Excel</Boton></div>

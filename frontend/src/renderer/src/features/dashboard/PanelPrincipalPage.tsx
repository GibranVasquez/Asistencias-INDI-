...
export default function PanelPrincipalPage() {
  ...
  const accionesRapidas = sesion!.usuario.rol === "administrador"
    ? [
        { titulo: "Usuarios", detalle: "Administrar accesos", ruta: ruta("usuarios"), icono: "usuarios" },
        { titulo: "Terminales", detalle: "Gestionar dispositivos", ruta: ruta("terminales"), icono: "terminal" },
      ]
    : [
        { titulo: "Nuevo trabajador", detalle: "Registrar personal", ruta: "/panel/trabajadores/nuevo", icono: "agregar" },
        { titulo: "Asistencias", detalle: "Revisar marcaciones", ruta: ruta("asistencias"), icono: "asistencia" },
        { titulo: "Nómina", detalle: "Preparar semana", ruta: ruta("nomina"), icono: "nomina" },
        { titulo: "Reportes", detalle: "Consultar resultados", ruta: ruta("reportes"), icono: "reporte" },
      ];
